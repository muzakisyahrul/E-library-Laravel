...
@section('content')
<div ng-controller="RakBukuController">
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
          ...
          <form class="form form-horizontal">
            ...
            <label class="col-md-3">Nama Rak:</label>
            <div class="col-md-9">
              <input type="text" class="form-control" data-ng-model="rak.nama_rak" placeholder="Masukkan Nama Rak" />
            </div>
          </div>
          </form>
	      </div>
...
<script src="{{asset('/')}}app/controllers/Master/RakBukuController.js"></script>
@endsection 