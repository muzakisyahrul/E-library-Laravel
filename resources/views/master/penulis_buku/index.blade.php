...
@section('content')
<div ng-controller="PenulisBukuController">
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
          ...
          <form class="form form-horizontal">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control" data-ng-model="penulis.nama" placeholder="Masukkan Nama Penulis" />
            </div>
          </div>
          <div class="form-group row">
            <label class="col-md-3">Tahun Lahir:</label>
            <div class="col-md-9">
              <input type="text" class="form-control" data-ng-model="penulis.tahun_lahir" placeholder="Tahun Lahir Penulis" />
            </div>
          </div>
          <div class="form-group row">
            <label class="col-md-3">Tempat Lahir:</label>
            <div class="col-md-9">
              <input type="text" class="form-control" data-ng-model="penulis.tempat_lahir" placeholder="Tempat Lahir Penulis" />
            </div>
          </div>
          <div class="form-group row">
            <label class="col-md-3">Kebangsaan:</label>
            <div class="col-md-9">
              <input type="text" class="form-control" data-ng-model="penulis.kebangsaan" placeholder="Kebangsaan Penulis" />
            </div>
          </div>
          </form>
	      </div>
...
<script src="{{asset('/')}}app/controllers/Master/PenulisBukuController.js"></script>
@endsection 