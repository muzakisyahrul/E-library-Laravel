...
@section('content')
<div ng-controller="PetugasController">
	...
	<div id="Modal" class="modal fade" role="dialog" data-backdrop="false">
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
          ...
          <form class="form form-horizontal" id="formulir">
          @csrf
          <div class="form-group row">
            <label class="col-md-3">Nip:</label>
            <div class="col-md-9">
              <input type="text" class="form-control" data-ng-model="user.nip" name="nip" placeholder="Masukkan Nip" />
            </div>
          </div>
	        <div class="form-group row">
            <label class="col-md-3">Nama:</label>
            <div class="col-md-9">
              <input type="text" class="form-control" data-ng-model="user.nama" name="nama" placeholder="Masukkan Nama" />
            </div>
          </div>
          <div class="form-group row">
            <label class="col-md-3">Email:</label>
            <div class="col-md-9">
              <input type="text" class="form-control" data-ng-model="user.email" name="email" placeholder="Masukkan Email" />
            </div>
          </div>
          <div class="form-group row">
            <label class="col-md-3" data-ng-bind="label_password"></label>
            <div class="col-md-9">
              <input type="password" class="form-control" data-ng-model="user.password" name="password" placeholder="Masukkan Password" />
            </div>
          </div>
          <div class="form-group row">
            <label class="col-md-3">Foto:</label>
            <div class="col-md-9">
              <img class="img-circle elevation-2 mb-2" ng-src="@{{user.photo || '//:0'}}" width="100px" height="100px" id="src_photo" /><br/>
              <input type="file" ng-file-select="onFileSelect($files)" name="photo" id="photo" data-ng-model="user.photo">            
            </div>
          </div>
          </form>
	      </div>
...
<script src="{{asset('/')}}app/controllers/Master/PetugasController.js"></script>
@endsection 