...
@section('content')
<div ng-controller="KategoriBukuController">
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
          ...
          <form class="form form-horizontal">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control" data-ng-model="kategori.nama_kategori" placeholder="Masukkan Nama Kategori" />
            </div>
          </div>
          </form>
	      </div>
...
<!-- controller.js -->
<script src="{{asset('/')}}app/controllers/Master/KategoriBukuController.js"></script>
@endsection 