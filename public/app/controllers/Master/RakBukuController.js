myApp.controller('RakBukuController', function($scope,$compile, $http, BASE_URL,DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder,$window){

          var URL_LINK = BASE_URL+'/home/master/rak_buku';
          // start datatable
          $scope.vm = {};
          ...
          $scope.vm.dtColumns = [
              ...
              DTColumnBuilder.newColumn('nama_rak').withTitle('Nama Rak'),
          ...
          $scope.showModal = function(state,id){
            ...
            if(state == 'add'){
              ...
              .then(function success(e){  
                  var data = e.data;
                  $scope.rak_id  = data.id;
                  $scope.rak.nama_rak  = data.nama_rak;
                }, function error(res) {
                console.log(res);
              });
            }
