myApp.controller('AnggotaController', function($scope,$compile, $http, BASE_URL,DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder,$window){

          var URL_LINK = BASE_URL+'/home/master/anggota';
          // start datatable
          $scope.vm = {};
          ...
          $scope.vm.dtColumns = [
              ...
              DTColumnBuilder.newColumn('no_telepon').withTitle('No Telepon'),
          ...
          $scope.showModal = function(state,id){
            ...
            if(state == 'add'){
              ...
              .then(function success(e){  
                  var data = e.data;
                  $scope.anggota_id             = data.id;
                  $scope.anggota.nomor_anggota  = data.nomor_anggota;
